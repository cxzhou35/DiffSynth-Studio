...
class RaftOpticalFlow(rp.CachedInstances):
    def __init__(self, device, version='large'):
        ...
        # checkpoint = torch.load("/nas_ins/aigc_human_relight/taoming_work/trained_model/RAFT/raft_large_C_T_SKHT_V2-ff5fadd5.pth", map_location=device)  # 或者 "cuda" 如果你使用 GPU
