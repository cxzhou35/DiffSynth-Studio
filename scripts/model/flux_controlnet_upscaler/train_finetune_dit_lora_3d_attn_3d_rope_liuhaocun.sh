...
SCENE_ID="liuhaocun_1440p"
TIMESTAMP=$(date +"%Y%m%d%H%M%S")
DATASET_BASE_PATH="data/${SCENE_ID}"
DATASET_METADATA_PATH="${DATASET_BASE_PATH}/controlnet_data/metadata_train_split_4.json"
OUTPUT_PATH="outputs/${SCENE_ID}_${TIMESTAMP}/FLUX.1-Controlnet-Upscale-dit-lora_3d_attn_3d_rope_liuhaocun"
