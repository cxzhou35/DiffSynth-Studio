...
DATASET_METADATA_PATH="${DATASET_BASE_PATH}/controlnet_data/metadata_train_part.json"
OUTPUT_PATH="outputs/${SCENE_ID}_${TIMESTAMP}/FLUX.1-Controlnet-Upscale-dit-lora_3d_attn_3d_rope_gs_fix"
