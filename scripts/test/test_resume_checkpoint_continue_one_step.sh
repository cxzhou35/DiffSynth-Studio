...
TEST_ID="resume_continue_one_step"
...
PRETRAINED_MODEL_PATH="/home/vercent/codes/DiffSynth-Studio/outputs/resume_save_one_step_20260502125303/FLUX.1-Controlnet-Upscale-dit-lora_checkpoint_test/epoch-0-step-1.safetensors"
...
if [[ ! -d "${PRETRAINED_MODEL_PATH%.safetensors}_state" ]]; then
    echo "Missing pretrained state dir: ${PRETRAINED_MODEL_PATH%.safetensors}_state" >&2
    exit 1
fi
